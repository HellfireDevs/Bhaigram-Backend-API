...
# Use a viral meme account
user_id = cl.user_id_from_username("memezar")
print(f"Fetching reels for memezar (ID: {user_id})...")

reels = cl.user_clips(user_id, amount=4)
